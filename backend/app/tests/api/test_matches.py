...
from app.models.participants import MatchParticipant
...
class TestMatchEndpoints:
    ...
    def test_get_player_matches_success(self, client, mock_match_service, sample_match_list_response):
    ...
    def test_get_player_matches_with_filters(self, client, mock_match_service, sample_match_list_response):
        ...
        puuid = str(uuid4())
        response = client.get(f"/matches/player/{puuid}?queue=420&start=10&count=50&start_time=1710000000000&end_time=1710086400000")
    ...
    def test_get_match_details_success(self, client, mock_match_service, sample_match_response):
    ...
    def test_get_player_match_stats_success(self, client, mock_match_service, sample_match_stats_response):
    ...
    def test_search_matches_success(self, client, mock_match_service, sample_match_list_response):
    ...
    def test_get_match_participants_success(self, client, mock_match_service):
        ...
        # Verify service call
        mock_match_service.get_match_by_id_with_participants.assert_called_once_with(match_id)
    ...
    def test_get_detailed_player_stats_success(self, client, mock_stats_service):
        ...
        mock_stats_service.calculate_player_statistics.return_value = {
            ...
            'champion_stats': {
                'Ahri': {'matches': 10, 'wins': 6, 'win_rate': 0.6}
            },
            'position_stats': {
                'MIDDLE': {'matches': 30, 'wins': 18, 'win_rate': 0.6}
            }
        }
