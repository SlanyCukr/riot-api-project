...
class MatchTransformer:
    ...
    def extract_encounters_from_match(
        self, match_data: Dict[str, Any], target_puuid: str
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for participant in participants:
                ...
                is_teammate = participant.get("teamId") == target_participant.get(
                    "teamId"
                )
            ...
            logger.error(
                "Failed to extract encounters from match",
                match_id=match_data.get("metadata", {}).get("matchId"),
    ...
    def filter_participant_fields(
        self, participant: Dict[str, Any], fields: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def aggregate_match_statistics(
