...
from sqlalchemy import String, Text, DateTime as SQLDateTime, Float, Integer, JSON
...
class JobExecutionORM(Base):
    """Enhanced Matchmaking Analysis model with rich domain methods"""

    __tablename__ = "matchmaking_analysis_jobs"
    ...
    created_at: Mapped[datetime] = mapped_column(
        SQLDateTime(timezone=True), default=lambda: datetime.now(timezone.utc)
    )
    ...
    matches_analyzed: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
