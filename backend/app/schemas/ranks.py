...
class PlayerRankBase(BaseModel):
    ...
    season_id: Optional[str] = Field(None, max_length=16, description="Season identifier")
...
class PlayerRankUpdate(BaseModel):
    ...
    rank: Optional[str] = Field(None, max_length=4, description="Rank division")
    league_points: Optional[int] = Field(None, ge=0, le=100, description="League points")
    ...
    fresh_blood: Optional[bool] = Field(None, description="Whether the player is fresh blood")
    hot_streak: Optional[bool] = Field(None, description="Whether the player is on a hot streak")
    league_id: Optional[str] = Field(None, max_length=64, description="League ID")
    league_name: Optional[str] = Field(None, max_length=64, description="League name")
    season_id: Optional[str] = Field(None, max_length=16, description="Season identifier")
    is_current: Optional[bool] = Field(None, description="Whether this is the current rank")
...
class PlayerRankResponse(PlayerRankBase):
    ...
    updated_at: datetime = Field(..., description="When this rank record was last updated")
...
class PlayerRankSearchRequest(BaseModel):
    ...
    min_league_points: Optional[int] = Field(None, ge=0, le=100, description="Minimum league points")
