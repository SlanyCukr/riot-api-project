...
class MatchResponse(MatchBase):
    ...
    game_start_datetime: Optional[datetime] = Field(
        None, description="Game creation as a datetime object"
    )
    game_end_datetime: Optional[datetime] = Field(
        None, description="Game end as a datetime object"
    )
    patch_version: Optional[str] = Field(
        None, description="Extracted patch version from game version"
    )
...
class MatchSearchRequest(BaseModel):
    ...
    game_version: Optional[str] = Field(
        None, max_length=32, description="Game version to filter by"
    )
