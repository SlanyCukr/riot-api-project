...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_matches_game_creation"), "matches", ["game_creation"], unique=False
    )
    op.create_index(
        op.f("ix_matches_game_mode"), "matches", ["game_mode"], unique=False
    )
    op.create_index(
        op.f("ix_matches_game_type"), "matches", ["game_type"], unique=False
    )
    op.create_index(
        op.f("ix_matches_game_version"), "matches", ["game_version"], unique=False
    )
    op.create_index(
        op.f("ix_matches_is_processed"), "matches", ["is_processed"], unique=False
    )
    op.create_index(op.f("ix_matches_match_id"), "matches", ["match_id"], unique=False)
    op.create_index(
        op.f("ix_matches_platform_id"), "matches", ["platform_id"], unique=False
    )
    ...
    op.create_index(
        "idx_players_riot_tag", "players", ["riot_id", "tag_line"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_players_is_active"), "players", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_players_last_seen"), "players", ["last_seen"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_players_summoner_id"), "players", ["summoner_id"], unique=False
    )
    op.create_index(
        op.f("ix_players_summoner_name"), "players", ["summoner_name"], unique=False
    )
    op.create_table(
        "match_participants",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_match_participants_champion_id"),
        "match_participants",
        ["champion_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_match_participants_champion_name"),
        "match_participants",
        ["champion_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_match_participants_individual_position"),
        "match_participants",
        ["individual_position"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_match_participants_role"), "match_participants", ["role"], unique=False
    )
    op.create_index(
        op.f("ix_match_participants_team_id"),
        "match_participants",
        ["team_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_match_participants_team_position"),
        "match_participants",
        ["team_position"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_ranks_puuid_current", "player_ranks", ["puuid", "is_current"], unique=False
    )
    op.create_index(
        "idx_ranks_puuid_queue", "player_ranks", ["puuid", "queue_type"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_ranks_tier_lp", "player_ranks", ["tier", "league_points"], unique=False
    )
    op.create_index(
        "idx_ranks_tier_rank", "player_ranks", ["tier", "rank"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_is_current"), "player_ranks", ["is_current"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_league_id"), "player_ranks", ["league_id"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_puuid"), "player_ranks", ["puuid"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_queue_type"), "player_ranks", ["queue_type"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_rank"), "player_ranks", ["rank"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_season_id"), "player_ranks", ["season_id"], unique=False
    )
    op.create_index(
        op.f("ix_player_ranks_tier"), "player_ranks", ["tier"], unique=False
    )
    op.create_table(
        "smurf_detections",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_smurf_detections_confidence"),
        "smurf_detections",
        ["confidence"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_false_positive_reported"),
        "smurf_detections",
        ["false_positive_reported"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_is_smurf"),
        "smurf_detections",
        ["is_smurf"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_last_analysis"),
        "smurf_detections",
        ["last_analysis"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_manually_verified"),
        "smurf_detections",
        ["manually_verified"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_puuid"), "smurf_detections", ["puuid"], unique=False
    )
    op.create_index(
        op.f("ix_smurf_detections_queue_type"),
        "smurf_detections",
        ["queue_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_smurf_detections_smurf_score"),
        "smurf_detections",
        ["smurf_score"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_smurf_detections_smurf_score"), table_name="smurf_detections"
    )
    ...
    op.drop_index(
        op.f("ix_smurf_detections_manually_verified"), table_name="smurf_detections"
    )
    op.drop_index(
        op.f("ix_smurf_detections_last_analysis"), table_name="smurf_detections"
    )
    ...
    op.drop_index(
        op.f("ix_match_participants_team_position"), table_name="match_participants"
    )
    op.drop_index(
        op.f("ix_match_participants_team_id"), table_name="match_participants"
    )
    ...
    op.drop_index(
        op.f("ix_match_participants_champion_name"), table_name="match_participants"
    )
    op.drop_index(
        op.f("ix_match_participants_champion_id"), table_name="match_participants"
    )
